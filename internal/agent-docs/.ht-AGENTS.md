...
For content-writing decisions, read `internal/agent-docs/.ht-CONTENT_GUIDE.md` before drafting or revising pages.

## How To Run Locally

Run the protected static server from the repository root:
...
- `internal/agent-docs/.ht-CONTENT_GUIDE.md`: pedagogical and authoring guidance for writing textbook-replacement content.
...
- Load `http://127.0.0.1:8099/DAIADS/?path=...` for the changed page.
