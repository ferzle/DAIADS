...
For authoring style and pedagogy, use `.ht-CONTENT_GUIDE.md`.
...
- The protected development server runs at `http://127.0.0.1:8099/DAIADS/`.

## Useful Routes For Smoke Testing

```text
http://127.0.0.1:8099/DAIADS/
http://127.0.0.1:8099/DAIADS/?path=Home%2FAbout
http://127.0.0.1:8099/DAIADS/?path=Algorithms%2FBrute%20Force%2FSelection%20Sort
http://127.0.0.1:8099/DAIADS/?path=Demos%2FBrute%20Force%2FSelection%20Sort%20Demo
http://127.0.0.1:8099/DAIADS/?path=More%2FGlossary
```
