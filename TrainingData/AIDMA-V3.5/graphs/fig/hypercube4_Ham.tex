...
%	 \node[vertex] (v7) at (1.23,1.4) {$0111$};
	 ...
	 \draw[edge,line width=3pt] (v1) -- (v3) ;
	 \draw[edge,line width=3pt] (v3) -- (v2) ;
	 \draw[edge] (v2) -- (v0);
	 \draw[edge] (v0) -- (v1);
	 
	 \draw[edge,line width=3pt] (v0) -- (v4) ;
	 \draw[edge] (v4) -- (v5);
	 \draw[edge,line width=3pt] (v5) -- (v1) ;
	 
	 \draw[edge,line width=3pt] (v2) -- (v6);
	 \draw[edge] (v6) -- (v7);
	 \draw[edge] (v7) -- (v3);
	 \draw[edge,line width=3pt] (v4) -- (v6);
	 \draw[edge,line width=3pt] (v7) -- (v5);
	 
	 \draw[edge,line width=3pt] (v8) -- (v9);
	 \draw[edge,line width=3pt] (v9) -- (v13);
	 \draw[edge,line width=3pt] (v13) -- (v12);
	 \draw[edge] (v4) -- (v12);
	 \draw[edge] (v12) -- (v8);
	 \draw[edge,line width=3pt] (v8) -- (v0);
	 \draw[edge] (v1) -- (v9);
	 \draw[edge] (v13) -- (v5);
	 \draw[edge] (v2) -- (v10);
	 \draw[edge,line width=3pt] (v10) -- (v14);
	 \draw[edge] (v14) -- (v6);
	 \draw[edge] (v8) -- (v10);
	 \draw[edge,line width=3pt] (v14) -- (v12);
	 \draw[edge] (v3) -- (v11);
	 \draw[edge,line width=3pt] (v11) -- (v15);
	 \draw[edge,line width=3pt] (v15) -- (v7);
	 \draw[edge,line width=3pt] (v10) -- (v11);
	 \draw[edge] (v15) -- (v14);
	 \draw[edge] (v9) -- (v11);
	 \draw[edge] (v15) -- (v13);
